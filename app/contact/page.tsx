...
export default function Profile() {
  ...
  <div className="relative flex flex-col items-center px-6 pb-6">
    ...
    <div className="mt-6 flex gap-3">
      <a className="px-5 py-2 bg-blue-600 text-white text-sm font-semibold rounded-lg shadow-md hover:bg-blue-700 transition" href="mailto:patipat.tra@rmutto.ac.th" target="_black">
        E-mail
      </a>
      <a className="px-5 py-2 border border-slate-300 text-slate-700 dark:text-slate-300 text-sm font-semibold rounded-lg hover:bg-slate-50 dark:hover:bg-slate-700 transition"href="https://github.com/rtx3080ti-rgb/biw-next-app" target="_black">
        Github
      </a>
    </div>

    <div className="flex mt-6 space-x-4">
      <a href="https://vt.tiktok.com/ZSXDYQbm1/" className="text-slate-400 hover:text-blue-500">
        <img className="w-10 h-10 rounded-full border border-white dark:border-slate-800 shadow-md object-cover"
           src="images\tiktok.png"
           alt="TikTok logo" />
      </a>
