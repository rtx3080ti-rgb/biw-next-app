export default function Footer() {
    return (
        <footer className="bg-pink-100 text-slate-300">
  <div className="max-w-7xl mx-auto px-6 py-12">
    <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
      <div className="md:col-span-1">
        <span className="text-2xl font-bold text-black">YourLogo</span>
        <p className="mt-4 text-sm text-slate-400">Xxx</p>
      </div>

      <div>
        <h4 className="text-sm font-semibold text-black uppercase tracking-wider">Xxx</h4>
      ...
      <div>
        <h4 className="text-sm font-semibold text-black uppercase tracking-wider">Subscribe</h4>
        <p className="mt-4 text-sm text-slate-400">Xxx</p>
        <form className="mt-4 flex max-w-md gap-2">
          ...
          <button type="submit" className="flex-none rounded-md bg-blue-600 px-4 py-2 text-sm font-semibold text-white hover:bg-blue-500 transition">Send</button>
        </form>
      </div>
    </div>
